...
public class AreaMapsActivity extends FragmentActivity implements
        OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonCalculate = findViewById(R.id.buttonCalcArea);
    ...
    public void onClick(View v) {
        if(v == buttonReset){
            ...
            double opp=SphericalUtil.computeArea(path);
            Toast.makeText(this, String.valueOf(opp), Toast.LENGTH_LONG).show();

            PostOppTask task = new PostOppTask(opp);
            task.execute();
        }
    }

    public class PostOppTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            try {
                String requestUrl = "http://" + ((GlobaleVariabelen) getApplication()).getIpServer() + ":8080/RetailSonarREST/rest_service/bedrijf/oppervlakte/set/";
        ...
        protected void onPostExecute(final Boolean success) {
            if (success) {
                ...
                System.out.println("error in AreaMapsActivity onPostExecute()");
            }
        }
